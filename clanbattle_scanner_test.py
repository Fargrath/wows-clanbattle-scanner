...
class TestClanBattleScanner(unittest.TestCase):
	...
	def test_csv_row(self):
		test_battle = Battle('04.04.20', '22:04', 'ClanBattlesTable__victory__1DrFU', 'Dreizack')
		test_battle.players.append('Player1')
		test_battle.ships.append('Ship1')
		expected_row = '04.04.20;22:04;Victory;Trident;Player1;Ship1'
...
"""
		expected_battle = Battle('04.04.20', '22:04', 'ClanBattlesTable__victory__1DrFU', 'Dreizack')
